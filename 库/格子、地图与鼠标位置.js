...
p.地图鼠标于舞台激活 = function(舞台) {
	...
	createjs.Ticker.addEventListener("tick", function(){
		...
		//在当前的设计这个光标实例的移动是与事件无关的，总是会触发。未来可能会移动到鼠标移至其他格子的事件里
		if(that.鼠标所在格){
		...
		//另外，如果鼠标移动到另一个格子或者界外，会触发一个UI事件。在玩家的操作请求中会对这个UI事件添加监听。
